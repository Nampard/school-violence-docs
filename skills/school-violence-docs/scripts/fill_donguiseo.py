...
{
  "종류": "자체해결",                 # "자체해결"(관련학생 2칸) | "종결"(3칸)
  "사안번호": "5", "사안연도": "2026",  # 사안연도 미지정 시 양식 기본 유지
  "학교명": "○○고등학교", "학교약칭": "○○고",  # 없으면 OO고 플레이스홀더 유지
  "사안내용": "",                     # (선택) 완곡 500자 내외. fill_form으로 채웠으면 생략
  "학생": [                           # 가해관련·피해관련 학생 인적사항 모두 기재(서명은 피해측 개인별)
    {"소속학교": "○○고등학교", "학년반": "1/3", "성명": "홍길동"},  # 학년반: '1학년 3반'→'1/3'
    {"소속학교": "○○고등학교", "학년반": "1/3", "성명": "김철수"}
  ]
}
"""
import sys, json, re
